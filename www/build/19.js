...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__checkout__ = __webpack_require__(749);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_cart_service_mock__ = __webpack_require__(369);
...
var CheckoutPage = /** @class */ (function () {
    function CheckoutPage(nav, navParams, ordersService, cartService, loadingCtrl, toastCtrl, serviceBackend) {
        this.nav = nav;
    ...
    CheckoutPage.prototype.getOrderRest = function () {
        var _this = this;
    ...
    CheckoutPage.prototype.send = function () {
        ...
        setTimeout(function () {
            loader.dismiss();
            toast.present();
            _this.serviceBackend.createorderandcleancart();
