...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__category__ = __webpack_require__(749);
...
var CategoryPage = /** @class */ (function () {
    ...
    CategoryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-category',template:/*ion-inline-start:"D:\NodeApps\Fyned\Movil\foodionic_6\src\pages\category\category.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Categorias</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n	<div class="card-background-page">\n\n	<ion-grid no-padding>\n		<ion-row no-padding>\n			<ion-col col-12 col-md-6 *ngFor="let category of catergoriesRest">\n				<ion-card tappable (click)="openRestaurantListPage(category.name)">\n					<img src="{{imagesCatUrl}}{{category.picture}}" />\n					<div class="card-title">{{category.name}}</div>\n					<div class="card-subtitle">Cantida de Restaurants</div>\n				</ion-card>\n			</ion-col>\n		</ion-row>\n	</ion-grid>\n\n	</div>\n\n</ion-content>\n'/*ion-inline-end:"D:\NodeApps\Fyned\Movil\foodionic_6\src\pages\category\category.html"*/,
        }),
